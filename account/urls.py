...
urlpatterns = [
    ...
    url(r'^(?P<company_id>.*?)/hr_get_interested_by_company$',views.interested_list_company,name='interested_list_company'),	
    ...
    url(r'^company/process_single', views.process_single, name='process_single'),
