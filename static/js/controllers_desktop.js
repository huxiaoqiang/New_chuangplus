                    ...
                    if(data.error.code == 1){
                        ...
                        if($scope.is_tsinghua != true)
                            ...
                            if(data.completive == '1')
                                ...
                                setTimeout(function(){window.location.href='/intern/information'},1000);
                        }
                    }
                    else{
...
//    }]).
    ...
    controller('DT_InformationCtrl',['$scope', '$http', 'CsrfService', 'urls','$rootScope',
      function($scope, $http, $csrf, urls,$rootScope){
